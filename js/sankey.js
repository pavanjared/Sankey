...
(function() {
  ...
  Sankey = (function() {
    ...
    Sankey.prototype.rootAdjustment = function(data) {
      var datum, _i, _len;
  ...
  FlowLine = (function() {
    function FlowLine(sankey, left_box_name, flow, line_size, right_box_name) {
      this.sankey = sankey;
      this.hover_stop = __bind(this.hover_stop, this);
      this.hover_start = __bind(this.hover_start, this);
      this.setFlow(flow, line_size);
      this.colour = void 0;
      this.ox = 0;
      this.oy = 0;
      this.dx = 0;
    ...
    FlowLine.prototype.setFlow = function(flow, line_size) {
      this.flow = flow;
      return this.size = this.sankey.convert_flow_values_callback(line_size);
    };
  ...
  TransformationBox = (function() {
    ...
    TransformationBox.prototype.position_and_colour_lines = function() {
      var box_width, left_lines, line, ly, right_lines, ry, _i, _j, _len, _len1, _ref, _results;
